...
public class RelojDigitalBeanInfo extends SimpleBeanInfo {
    ...
    private static final int PROPERTY_alarma = 0;
    private static final int PROPERTY_background = 1;
    private static final int PROPERTY_font = 2;
    private static final int PROPERTY_formato = 3;
    private static final int PROPERTY_height = 4;
    private static final int PROPERTY_horizontalAlignment = 5;
    private static final int PROPERTY_horizontalTextPosition = 6;
    private static final int PROPERTY_maximumSize = 7;
    private static final int PROPERTY_minimumSize = 8;
    private static final int PROPERTY_reloj = 9;
    private static final int PROPERTY_size = 10;
    private static final int PROPERTY_text = 11;
    private static final int PROPERTY_toolTipText = 12;
    private static final int PROPERTY_verticalAlignment = 13;
    private static final int PROPERTY_verticalTextPosition = 14;
    private static final int PROPERTY_visible = 15;
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            properties[PROPERTY_alarma] = new PropertyDescriptor ( "alarma", componenterelojdigital.RelojDigital.class, "getAlarma", "setAlarma" ); // NOI18N
            properties[PROPERTY_alarma].setDisplayName ( "alarma" );
            properties[PROPERTY_alarma].setPropertyEditorClass ( componenterelojdigital.AlarmaPropertyEditor.class );
